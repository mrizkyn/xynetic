      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 md:gap-14 lg:gap-16 items-start max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="space-y-5 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 group cursor-pointer">
                <div className="p-3 sm:p-4 rounded-full bg-black/5 border border-black/10 group-hover:bg-primary/20 group-hover:border-primary/50 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 sm:gap-4 group cursor-pointer">
                <div className="p-3 sm:p-4 rounded-full bg-black/5 border border-black/10 group-hover:bg-green-500/20 group-hover:border-green-500/50 transition-all duration-300">
                  <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6 text-foreground group-hover:text-green-500 transition-colors" />
                </div>
                <div>
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Chat on WhatsApp
          ...
          <motion.div
            ...
            className="bg-white shadow-md border border-black/10 rounded-2xl md:rounded-3xl p-6 sm:p-7 md:p-8 lg:p-10"
          >
            {success ? (
              <motion.div
                ...
                <div className="space-y-5 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                    <FloatingInput
                      ...
                      type="text"
                    />
                    <FloatingInput id="budget" label="Budget" type="text" />
                  </div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      required
                      rows={4}
                      className="peer block w-full appearance-none border-0 border-b border-black/20 bg-transparent px-0 py-2.5 text-base sm:text-lg text-slate-900 focus:border-primary focus:outline-none focus:ring-0"
                      placeholder=" "
                    />
                    <label
                      htmlFor="message"
                      className="absolute top-3 z-10 pointer-events-none origin-[0] -translate-y-6 scale-75 transform text-sm sm:text-base text-slate-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-primary"
                    >
