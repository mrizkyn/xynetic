...
export function CtaSection() {
  return (
    <section className="py-20 sm:py-24 md:py-32 relative overflow-hidden bg-background border-t border-black/5 w-full">
      {/* Background Glow */}
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 relative z-10 text-center">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-foreground mb-6 md:mb-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 sm:mb-10 md:mb-12 max-w-2xl mx-auto px-4">
            Join forces with Bivara to transform your ambitious ideas into
          ...
          <Link
            ...
            className={cn(
              ...
              "shadow-[0_0_20px_rgba(15,23,42,0.2)] hover:shadow-[0_0_30px_rgba(15,23,42,0.3)] hover:-translate-y-1",
            )}
          >
            Start Your Project
